...
const AboutUs = () => {
    return (
        <div className='bg-Hero-bg  py-14 md:py-20 lg:pt-[104px] lg:pb-[113px]  overflow-hidden relative ' id='About'>
            ...
            <div className='container mx-auto xl:w-[1140px] 2xl:w-[1320px] px-3 sm:px-5 xl:px-0'>
                <div className='w-full flex flex-col lg:flex-row'>
                    <div className='w-full lg:w-6/12 lg:mb-0 mb-10' data-aos="fade-right" data-aos-duration="700" data-aos-delay="500" data-aos-easing="linear">
                        ...
                        <button aria-label='Sell Your App' className='text-white text-xsm md:text-sm font-bold font-Manrope leading-[170%] inline-block px-8 py-3 md:px-10  md:py-4 bg-gradient-to-r from-red-500 to-indigo-600 hover:to-red-500 hover:from-indigo-600 rounded-[38px] transition-all ease-linear duration-300 relative z-10'>Sell Your App</button>
                    </div>
                    <div className='w-full lg:w-6/12 flex lg:flex-col flex-wrap gap-4 lg:items-end items-center justify-center' >
                        <div className='flex lg:flex-col md:flex-row flex-col gap-4 lg:gap-0' >
                            <div className='bg-Hero-bg max-w-[395px] cursor-pointer z-[1]  mb-5 rounded-[12px] border border-[rgb(51_23_63)] lg:ps-6 lg:pe-10 lg:py-5 p-5 bg-[rgba(255_255_255_0.04)] inline-block relative overflow-hidden' data-aos="fade-left" data-aos-duration="700" data-aos-delay="600" data-aos-easing="linear">
                            ...
                            <div className='bg-Hero-bg max-w-[395px] cursor-pointer z-[1]  w-ful  mb-5 rounded-[12px] border border-[rgb(51_23_63)] lg:ps-6 lg:pe-10 lg:py-5 p-5 bg-[rgba(255_255_255_0.04)] inline-block relative overflow-hidden' data-aos="fade-left" data-aos-duration="700" data-aos-delay="800" data-aos-easing="linear">
                        ...
                        <div className='bg-Hero-bg max-w-[395px] cursor-pointer z-[1] relative  rounded-[12px] border border-[rgb(51_23_63)] lg:ps-6 lg:pe-5 plg:y-5 p-5 bg-[rgba(255_255_255_0.04)] inline-block overflow-hidden' data-aos="fade-left" data-aos-duration="700" data-aos-delay="1000" data-aos-easing="linear">
