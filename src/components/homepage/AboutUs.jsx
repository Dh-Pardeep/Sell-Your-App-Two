            ...
            <div className='container mx-auto'>
                <div className='w-full flex flex-col lg:flex-row'>
                    <div className='w-full lg:w-6/12 lg:mb-0 mb-10'  data-aos="fade-right" data-aos-duration="1000" data-aos-delay="500" data-aos-easing="linear">
                        ...
                        <button className='text-white text-[14px] md:text-base font-bold font-Manrope leading-[170%] inline-block px-10 py-4 bg-gradient-to-r from-red-500 to-indigo-600 hover:to-red-500 hover:from-indigo-600 rounded-[38px] transition-all ease-linear duration-300'>Sell Your App</button>
                    </div>
                    <div className='w-full lg:w-6/12 flex flex-col lg:items-end items-center' data-aos="fade-left" data-aos-duration="1000" data-aos-delay="500" data-aos-easing="linear">
                        <div className='cursor-pointer z-[1] sm:w-[395px] mb-5 rounded-[12px] border border-[rgb(51_23_63)] ps-6 pe-10 py-5 bg-[rgba(255_255_255_0.04)] inline-block relative'>
                            <span className='absolute bottom-[0] left-[50%] translate-x-[-50%] z-[-1]'><Transparency /></span>
                            <span><Check /></span>
                        ...
                        <div className='cursor-pointer z-[1] relative w-full sm:w-[395px] mb-5 rounded-[12px] border border-[rgb(51_23_63)] ps-6 pe-10 py-5 bg-[rgba(255_255_255_0.04)] inline-block'>
                            <span className='absolute bottom-[0] left-[50%] translate-x-[-50%] z-[-1]'><Highest /></span>
                            <span><Check /></span>
