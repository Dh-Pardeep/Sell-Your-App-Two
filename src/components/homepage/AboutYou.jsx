        ...
        <div className="relative about_bg sm:p-10 px-3 py-7 w-[922px] rounded-[40px]">
          ...
          <div className="flex justify-center py-5 sm:py-8 md:py-11">
            <button
              ...
              className="mb-1 text-white text-xsm md:text-sm font-bold font-Manrope leading-[170%] inline-block px-8 md:px-10 py-3 md:py-4 bg-gradient-to-r from-red-500 to-indigo-600 hover:to-red-500 hover:from-indigo-600 rounded-[38px] transition-all ease-linear duration-300 opacity-100"
            >
              Submit Now
            </button>
          </div>
          <div className="flex justify-center sm:pb-0  about_you_gradient relative max-w-[556px] mx-auto">
