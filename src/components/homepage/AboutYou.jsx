            ...
            <div className='container mx-auto flex justify-center xl:w-[1140px] 2xl:w-[1320px] px-3 sm:px-5 xl:px-0'>
                <div className='relative about_bg sm:p-10 px-3 py-7 w-[922px] rounded-[40px]'>
                    ...
                    <div className='sm:px-[23px]'>
                        ...
                        <input required className='outline-none leading-[170%] px-2 w-full sm:mb-6 mb-4 text-[15px] lg:text-sm font-normal opacity-90 text-black-light font-Inter bg-white ps-[10px] pt-[10px] pb-[7px] rounded-lg border border-[rgba(28_28_28_0.08)]' type="text" placeholder='App URL...' />
