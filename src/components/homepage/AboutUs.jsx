...
const AboutUs = () => {
    return (
        <div className='bg-Hero-bg   py-14 lg:pt-[100px] lg:pb-[113px] relative overflow-hidden'>
            <img className='absolute bottom-[-22%] left-[0]' src={about_vector} alt="shadow" />
            <div className='container mx-auto xl:w-[1140px] 2xl:w-[1320px] px-3 sm:px-5 xl:px-0'>
                <div className='w-full flex flex-col lg:flex-row'>
                    <div className='w-full lg:w-6/12 lg:mb-0 mb-10'>
                        ...
                        <button className='text-white text-xsm md:text-sm font-bold font-Manrope leading-[170%] inline-block px-10 py-4 bg-gradient-to-r from-red-500 to-indigo-600 hover:to-red-500 hover:from-indigo-600 rounded-[38px] transition-all ease-linear duration-300'>Sell Your App</button>
                    </div>
                    <div className='w-full lg:w-6/12 flex lg:flex-col flex-wrap gap-4 lg:items-end items-center justify-center'>
                        <div className='flex lg:flex-col md:flex-row flex-col gap-4 lg:gap-0'>
                            <div className='overflow-hidden max-w-[395px] cursor-pointer z-[1]  mb-5 rounded-[12px] border border-[rgb(51_23_63)] lg:ps-6 lg:pe-10 lg:py-5 p-5 bg-[rgba(255_255_255_0.04)] inline-block relative'>
                                <div class="w-[185px] h-[53px] bg-gradient-to-r from-red-500 to-indigo-600 rounded-full blur-[80px] absolute bottom-[60px] left-[50%] translate-x-[-50%] z-[-1]"></div>
                                <span><Check /></span>
                            ...
                            <div className='overflow-hidden max-w-[395px] cursor-pointer z-[1] relative w-ful  mb-5 rounded-[12px] border border-[rgb(51_23_63)] lg:ps-6 lg:pe-10 lg:py-5 p-5 bg-[rgba(255_255_255_0.04)] inline-block'>
                                <div class="w-[185px] h-[53px] bg-cyan-400 rounded-full blur-[80px] absolute bottom-[60px] left-[50%] translate-x-[-50%] z-[-1]'"></div>
                                <span><Check /></span>
                        ...
                        <div className='overflow-hidden    max-w-[395px] cursor-pointer z-[1] relative  rounded-[12px] border border-[rgb(51_23_63)] lg:ps-6 lg:pe-5 plg:y-5 p-5 bg-[rgba(255_255_255_0.04)] inline-block'>
                            <span className='absolute bottom-[0] left-[50%] translate-x-[-50%] z-[-1]'><Safe /></span>
                            <span><Check /></span>
