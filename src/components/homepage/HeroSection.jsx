...
const HeroSection = () => {
  return (
    <div className='bg-Hero-bg rounded-br-[32px] rounded-bl-[32px]  relative overflow-hidden mb-14'>
      ...
      <div className="absolute -right-60 w-[545px] h-[878px] origin-top-left rotate-[26.13deg] bg-red-500 bg-opacity-20 blur-[407px]" />
      <HeaderNav />
      <div className="container xl:w-[1140px] 2xl:w-[1320px]  px-3 sm:px-5 xl:px-0 mx-auto">
        <div className='mt-44 sm:mt-52 lg:mt-60 flex flex-col xl:flex-row relative z-20'>
          <div className='w-full xl:w-6/12 xl:mt-16' data-aos="fade-right" data-aos-duration="700" data-aos-delay="500" data-aos-easing="linear">
          ...
          <div className='w-full xl:w-6/12 ' data-aos="fade-left" data-aos-duration="700" data-aos-delay="500" data-aos-easing="linear">
            <div className='relative'>
              ...
              <img className='md:w-[70%] lg:w-[80%] xl:w-full xl:h-[550px] mx-auto xl:translate-x-[10%]' src={Hero_Men_img} alt="" />
            </div>
          </div>
        </div>
      </div>
