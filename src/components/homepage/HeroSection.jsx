        ...
        <div className='mt-44 sm:mt-52 lg:mt-60 flex flex-col xl:flex-row relative z-20'>
          <div className='w-full xl:w-6/12 xl:mt-16' data-aos="fade-right" data-aos-duration="700" data-aos-delay="3000" data-aos-easing="linear">
            ...
            <div className=" lg:pb-20 ">
              <button className=" text-white text-xsm md:text-sm font-bold font-Manrope leading-[170%] inline-block  py-3 px-8 md:px-10 md:py-4 bg-gradient-to-r from-red-500 to-indigo-600 hover:to-red-500 hover:from-indigo-600 rounded-[38px] transition-all ease-linear duration-300 ">Sell Your App</button>
            </div>
          </div>
          <div className='w-full xl:w-6/12 ' data-aos="fade-left" data-aos-duration="700" data-aos-delay="3000" data-aos-easing="linear">
            <div className='relative'>
              ...
              <img className='md:w-[70%] lg:w-[80%] xl:w-full xl:h-[554px] mx-auto xl:translate-x-[10%] min-h-[280px]' src={Hero_Men_img} alt="" />
            </div>
          </div>
        </div>
      </div>
