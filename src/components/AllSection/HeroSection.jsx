...
const HeroSection = () => {
  return (
    <section className='bg-Hero-bg rounded-br-[32px] rounded-bl-[32px]  relative'>
      <HeaderNav />
      <div className='w-[400px] h-[680px] rotate-[26deg] blur-[75px] absolute bg-[#4844F2] opacity-[0.2] left-[120px]'></div>
      <div className="absolute end-0 w-[546.90px] h-[878.92px] origin-top-left rotate-[26.13deg] bg-red-500 bg-opacity-20 blur-[407px]" />
        ...
        <div className='flex flex-col lg:flex-row pt-72 justify-between items-center'>
          ...
          <div className='w-full lg:w-6/12'>
            <div className='relative'>
              <img className='absolute ' src={HeroImgBackgroud} alt="Back Ground image" />
