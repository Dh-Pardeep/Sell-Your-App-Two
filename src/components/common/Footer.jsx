        ...
        <div className="lg:flex justify-between">
          ...
          <div className="sm:flex lg:justify-start justify-center lg:gap-20 sm:gap-28">
            <ul className="text-center sm:text-start mt-10 lg:mt-[90px] flex flex-col">
              <li className="text-white font-Inter leading-7 font-medium text-sm mt-4">
                Quick Links
              </li>
              <li>
                <a className="opacity-80 text-white hover:opacity-60 inline-block font-Inter cursor-pointer leading-7 mb-0 font-medium text-sm mt-4">
                  About
                </a>
              </li>
              <li>
                <a className="opacity-80 text-white hover:opacity-60 inline-block font-Inter cursor-pointer leading-7 mb-0 font-medium text-sm mt-3">
                  App Sale process
                </a>
              </li>
              <li>
