    ...
    <div className="container mx-auto py-24 ">
      <div className="lg:flex items-center">
        <div className=" flex justify-center">
          <div
            className="lg:max-w-[766px] sm:mb-0 mb-12 max-w-[506px] bg-[#dd3b5c] xl:pt-16 pt-[26px] lg:pb-7 pb-10 xl:pe-[82px] px-6  xl:ps-[50px] lg:rounded-l-[30px] lg:rounded-r-[0px] sm:rounded-t-[30px] sm:rounded-none rounded-[30px]"
            data-aos="fade-right"
        ...
        <div
          className="bg-[#4f44ec] flex items-center lg:h-[450px] w-full rounded-3xl"
          data-aos="fade-left"
          data-aos-duration="700"
          data-aos-delay="500"
          data-aos-easing="linear"
