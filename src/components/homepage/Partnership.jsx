    ...
    return (
        <div className='bg-Hero-bg sm:py-10 py-6 lg:pt-[100px] lg:pb-[120px]'>
            <div className='container mx-auto'>
                <h2 className='lg:mb-[60px] text-center leading-[170%] font-Manrope text-[24px] md:text-[28px] lg:text-[30px] xl:text-lg font-medium text-white  ' data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500" data-aos-easing="linear">Partnership</h2>
