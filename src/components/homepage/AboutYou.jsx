...
const AboutYou = () => {
    return (
        <div className='py-14 lg:py-[104px]'>
            <div className='container mx-auto flex justify-center xl:w-[1140px] 2xl:w-[1320px] px-3 sm:px-5 xl:px-0'>
                <div className='relative about_bg sm:p-10 px-3 py-7 w-[922px] rounded-[40px]'>
                    ...
                    <div className='flex justify-center sm:mb-[44px] mb-4'><button aria-label='submit' className='text-white text-xsm md:text-sm font-bold font-Manrope leading-[170%] inline-block px-10 py-4 bg-gradient-to-r from-red-500 to-indigo-600 hover:to-red-500 hover:from-indigo-600 rounded-[38px] transition-all ease-linear duration-300 '>Submit Now</button></div>
                    <div className='flex justify-center sm:pb-0 pb-3'><p className='font-Manrope text-center about_text opacity-70 border border-[#FF3939] capitalize text-[17px] md:text-[18px] xl:text-xmd sm:px-10 px-3 sm:py-5 py-3 rounded-xl inline-block'>We guarantee to give you an offer within 48 hours</p></div>
                </div>
            </div>
        </div>
    )
