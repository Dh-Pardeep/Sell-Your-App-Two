  ...
  return (
    <div className="bg-Hero-bg py-14 md:py-20 lg:pt-[100px] lg:pb-[120px]">
      <div className="container mx-auto xl:w-[1140px] 2xl:w-[1320px] px-3 sm:px-5 xl:px-0">
        <h2 className="lg:mb-[60px] text-center  font-Manrope text-[24px] md:text-[28px] lg:text-[30px] xl:text-lg font-medium text-white mb-4 leading-normal">
          Partnership
        </h2>
        <div className="w-full flex flex-col lg:flex-row items-center lg:mb-[134px] mb-10">
          ...
          >
            <img
              className="hover:scale-[1.01] transition duration-400 ease-linear cursor-pointer min-h-[200px] min-w-[296px] sm:w-[580px] sm:h-[330px]  md:w-[600px] md:h-[340px] 2xl:w-full 2xl:h-full"
              src={phone_img}
              alt="phone_img"
            />
