...
const AboutYou = () => {
    return (
        <div className='py-10 lg:py-[104px]'>
                ...
                <div className='relative about_bg sm:p-[40px] p-[12px] w-[922px] rounded-[40px]'>
                    ...
                    <div className='sm:px-[23px] sm:mb-[44px] mb-4'>
                        <div className='flex flex-col sm:flex-row sm:gap-6 gap-3 sm:mb-6 mb-3'>
                            <input className='outline-none leading-[170%] px-2 w-full text-[15px] lg:text-sm font-normal opacity-90 text-black-light font-Inter bg-white leading-[174%] ps-[10px] pt-[10px] pb-[7px] rounded-lg border border-[rgba(28_28_28_0.08)]' type="text" placeholder='Your Name' />
                            <input required className='outline-none leading-[170%] px-2 w-full text-[15px] lg:text-sm font-normal opacity-90 text-black-light font-Inter bg-white leading-[174%] ps-[10px] pt-[10px] pb-[7px] rounded-lg border border-[rgba(28_28_28_0.08)]' type="text" placeholder='Your Email' />
                        </div>
                    ...
                    <div className='flex justify-center sm:pb-0 pb-3'><p className='font-Manrope text-center about_text opacity-70 border border-[#FF3939] capitalize text-[17px] md:text-[18px] xl:text-xmd sm:px-[40px] px-1 sm:py-5 py-2 rounded-xl inline-block'>We guarantee to give you an offer within 48 hours</p></div>
                </div>
            </div>
        </div>
    )
