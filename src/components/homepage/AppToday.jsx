      ...
      <div className="lg:flex items-center">
        <div className=" flex justify-center">
          <div className="lg:max-w-[766px] max-w-[506px] bg-[#dd3b5c] xl:pt-[79px] pt-[26px] pb-7 xl:pe-[82px] px-6  xl:ps-[50px] lg:rounded-l-[30px] lg:rounded-r-[0px] sm:rounded-t-[30px] sm:rounded-none rounded-[30px]" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="500" data-aos-easing="linear">
            ...
            <div className="max-w-[364px] rounded-xl py-5 px-10 bg-white mt-10 border border-[#DEDCEB]">
              <p className="about_text text-xmd font-medium font-Manrope">
        ...
        <div className="bg-[#4f44ec] flex items-center lg:h-[430px] w-full rounded-3xl" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="500" data-aos-easing="linear">
          <div className="w-full bg-card py-10 px-6">
            <div className="lg:flex gap-6 mb-6">
              <input
                className=" px-2 w-full outline-none text-[15px] lg:text-sm font-normal opacity-90 text-light-grey font-Inter bg-white leading-[174%] ps-[10px] pt-[10px] pb-[7px] rounded-lg border border-[#DEDCEB]"
                type="text"
                placeholder="Your Name"
              />
              <input
                required
                className=" px-2 w-full outline-none text-[15px] lg:text-sm font-normal opacity-90 text-light-grey font-Inter bg-white leading-[174%] ps-[10px] pt-[10px] pb-[7px] rounded-lg border border-[#DEDCEB] lg:mt-0 mt-6"
                type="text"
            ...
            <input
              required
              className=" px-2 w-full outline-none  mb-6 text-[15px] lg:text-sm font-normal opacity-90 text-light-grey font-Inter bg-white leading-[174%] ps-[10px] pt-[10px] pb-[7px] rounded-lg border border-[#DEDCEB]"
              type="text"
              placeholder="App URL..."
            />
            <textarea
              className=" px-2 w-full outline-none resize-none height-[74px] text-[15px] lg:text-sm font-normal opacity-90 text-light-grey font-Inter bg-white leading-[174%] ps-[10px] pt-[10px] pb-[7px] rounded-lg border border-[#DEDCEB]"
              type="text"
